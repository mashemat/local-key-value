...
//char * dynamic_block;
//int8_t synchronization_clock;

#define S_STG sizeof(struct stag)

//hashtable_t *   indirection_hash_table ;
//Keep some stuff global
//volatile int * server_req_area;

hash_item_t * server_hash_area; // struct hopscotch_bucket
hashtable_t * compact_hash;
struct local_cache_s  local_cache[4000000];
